...
3. **Update Site URL**:
   ...
   - Update "Site name" to something like `Abhishek Singh`
   - Your site will be available at `https://abhirajputt.netlify.app/`
...
4. **Update Canonical URLs**:
   ...
   - Replace `https://abhirajputt.netlify.app/` with your actual Netlify URL
...
4. Submit sitemap: `https://abhirajputt.netlify.app/sitemap.xml`
...
- Email: aabhisheksingh104@gmail.com
- Phone: 8969374762
